    ...
    H: BlockHeader,
{
    sanitize_chain_with_timestamp_policy(
        ...
        chain_id,
        max_simulate_blocks,
        |_, prev_timestamp, _, timestamp_increment| {
            prev_timestamp.saturating_add(timestamp_increment)
        },
...
pub fn sanitize_chain_with_timestamp_policy<TxReq, H>(
    ...
    chain_id: u64,
    max_simulate_blocks: u64,
    mut next_timestamp: impl FnMut(u64, u64, u64, u64) -> u64,
...
mod tests {
    ...
    fn sanitize_chain_supports_chain_specific_repeated_timestamps() {
        ...
        let out = super::sanitize_chain_with_timestamp_policy(
            ...
            Chain::mainnet().id(),
            256,
            |_, parent_timestamp, _, _| parent_timestamp,
